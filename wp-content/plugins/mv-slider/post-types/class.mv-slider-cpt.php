...
if( !class_exists( 'MV_Slider_Post_Type') ){
    class MV_Slider_Post_Type{
        function __construct(){
            ...
            add_action( 'manage_mv-slider_posts_columns', array( $this, 'mv_slider_cpt_columns' ) );
            add_action( 'manage_mv-slider_posts_custom_column', array( $this, 'mv_slider_custom_columns'), 10, 2 );
            add_filter( 'manage_edit-vm-slider_sortable_columns', array( $this, 'mv_slider_sortable_columns') );
        }
